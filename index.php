...
if ($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['submit'])) {
  $count = 0;
  $data = mysqli_query($conn, "select * from researcher_registration where emailid='$_POST[username]' && password='$_POST[password]'");
    ...
    <table style=" font-size:16pt" align="center" width="100%" height="100%">
      <tr>
        <td style="color:black">
          <h1 align="center">
            <marquee>Namaste To Online Academic Paper Management System</marquee>
          </h1>
        </td>
      </tr>
      ...
      <fieldset align="center" style="  background:rgba(0,0,0,0.38);color:blue;" class="five" class="one">
        ...
        <table style="font-size:16pt;width:300px;height:50px;margin-right:45px;" align="Right">
          ...
          <tr>
            ...
            <td><input type="text" name="username" placeholder="email" style="color:red"></td>
          </tr>
          ...
          <tr>
            <td style="color:white;font-size:12pt"><b>Not register yet.!</b></td>
