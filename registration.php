  ...
  <div class="boxtwo" style="border:solid 1px #CF0403;border-radius: 10px; width:73.5%; height:370px; margin-left:13%;margin-top:10px;background-color:white">
    ...
    <fieldset align="center" style="color:blue;" class="one">
      ...
      <form action="" method="post"> <b>
          <table align="center" style="color:white;font-size:13pt">
        </b>


        <tr>
          <td>NAME:</td>
          <td><input type="text" placeholder="username" required="required" name="name1" size="17" maxlength="30" style="color:blue" /></td>

        </tr>
        <tr>
          <td>Phone NO.:</td>
          <td><input type="text" name="phone" id="phone" placeholder="Phone No." required="required" size="17" maxlength="30" style="color:blue" value="" /></td>
        </tr>


        <tr>
          <td>E-MAIL ID:</td>
          <td><input type="email" placeholder="Email" name="email" required="required" size="17" maxlength="30" style="color:blue" /></td>
        </tr>
        <tr>
          <td>
            PASSWORD:</td>
          <td><input type="password" placeholder="Password" name="password" required="required" size="17" maxlength="30" style="color:blue" />
            <br>
            <input type="password" placeholder="Confirm Password" name="cpassword" required="required" size="17" maxlength="30" style="color:blue" /> </br>
          </td>
        </tr>
